    ...
    <>
      ...
      <Section tone="muted">
        ...
        <StaggerChildren
          ...
          itemClassName="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] px-6 py-5 text-sm text-[var(--color-text)]"
          step={60}
        >
      ...
      <Section tone="primary">
        ...
        <StaggerChildren className="mt-12 grid gap-8 sm:grid-cols-3" step={100}>
